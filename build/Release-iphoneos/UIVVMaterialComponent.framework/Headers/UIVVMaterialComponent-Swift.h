...
#ifndef UIVVMATERIALCOMPONENT_SWIFT_H
#define UIVVMATERIALCOMPONENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UIVVMaterialComponent",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21UIVVMaterialComponent19UIVVMaterialSpinner")
@interface UIVVMaterialSpinner : UIView
...
@interface UIView (SWIFT_EXTENSION(UIVVMaterialComponent))
...
@interface UIViewController (SWIFT_EXTENSION(UIVVMaterialComponent))
- (void)awakeFromNib;
- (void)keyboardWillShowWithNotification:(NSNotification * _Nonnull)notification active_view:(UIView * _Nonnull)active_view;
